...
public class ReportCommentArticleDbRepository:IReportCommentArticleDbRepository
{
    ...
    public async Task<ReportCommentArticleDto?> AddReportCommentArticleToDb(NewReportCommentArticleDto newReportCommentDto)
    {
        ...
        var reportCommentArticleExists = await _context.ReportCommentArticles
            .AnyAsync(e => e.IdReason == newReportCommentDto.IdReason
                           && e.IdUser == newReportCommentDto.IdUser
                           && e.IdCommentArticle == newReportCommentDto.IdComment);
        
        if (comment.IdUser == user.IdUser || reportCommentArticleExists)
        {
    ...
    public async Task<IEnumerable<ReportCommentArticleDto>> GetReportCommentArticlesFromDb()
    {
        ...
        return reportCommentArticle.OrderByDescending(x=>x.ReportedAt);
    }
}